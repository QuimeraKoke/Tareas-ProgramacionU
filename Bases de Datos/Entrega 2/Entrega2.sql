...
CREATE TABLE IF NOT EXISTS `Tarea2`.`ViajeB` (
  ...
  PRIMARY KEY (`bus_patente`, `recorrido_nombre`, `chofer_rut`,`hora`)  COMMENT '')
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `Tarea2`.`EstacionEnLinea` (
  ...
  `numero` INT,
  PRIMARY KEY (`Estacion_nombre`, `Linea_nombre`,`numero`)  COMMENT '')
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `Tarea2`.`ViajeM` (
  ...
  `hora` DATETIME NULL COMMENT '',
  `direccion` INT,
  PRIMARY KEY (`linea_nombre`, `conductor_rut`, `tren_patente`,`hora`,`direccion`)  COMMENT '')
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `Tarea2`.`Combinaciones` (
  `paradero_id` VARCHAR(15) NOT NULL COMMENT '',
  `estacion_nombre` VARCHAR(20) NOT NULL COMMENT '',
  PRIMARY KEY (`paradero_id`, `estacion_nombre`)  COMMENT '')
ENGINE = InnoDB;
